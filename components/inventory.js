	...
	return (
		<section className="inventory">
			...
			<div className="mx-auto content-wrapper">
				<ul className="flex flex-wrap font-Poppins px-0 items-start lg:justify-center justify-center">
					<AnimatePresence>
						{displayedInventory.map((inventory) => (
							<motion.li
								...
								// exit='exit'
								key={inventory.id}
								className="relative focus:outline-none mx-2 h-full w-full sm:w-[350px] xl:mb-0 mb-8"
							>
								<Link href={`/details/${inventory.id}`}>
									<a className="inline-flex flex-col w-full overflow-hidden">
										...
										<div className="relative flex items-center justify-center w-full sm:w-[350px] h-[220px]">
											<Image
