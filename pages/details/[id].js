			...
			<div className="content-wrapper">
				<div className="site-details__header">
					...
					<div className="site-details__header--action">
						<button
							onClick={() =>
								showModalWithProduct(machine.id, machine.type, machine.title)
							}
				...
				<div className="site-details__inner">
					<div className="site-details__truck-wrapper">
						<div
							...
							className="site-details__truck-wrapper__main-image"
						>
								...
								<ul>
									<li className="block">
										...
										<div className="action-buttons">
											...
											<a href="#chat" className="site-button site-button-chat">
												<svg
											...
											<a
												...
												className="site-button site-button-call"
											>
												<svg
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 24 24"
