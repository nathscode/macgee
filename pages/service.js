...
function Service() {
	return (
		<PageWrapper page="Service" path="/service">
						...
						<div className="pager-body__services__content">
							...
							<ul className="pager-body__services__content__box">
								<li className="pager-body__services__content__box__item">
									<div className="pager-body__services__content__box__item--icon">
										<svg
								...
								<li className="services__content__box__item">
									<div className="pager-body__services__content__box__item--icon">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											xmlSpace="preserve"
											viewBox="0 0 512 512"
										>
											<path d="M341.333 0H170.667C74.965 0 0 112.448 0 256s74.965 256 170.667 256h170.667C437.035 512 512 399.552 512 256S437.035 0 341.333 0zM87.189 96.021l25.728 25.728A21.336 21.336 0 0 0 128 128c1.387 0 2.795-.128 4.181-.427l66.283-13.248c-2.475 5.696-4.843 11.499-7.019 17.493-.107.32-.256.619-.363.939-2.325 6.443-4.395 13.141-6.336 19.947l-70.976 15.851-42.667-44.629c4.844-10.091 10.262-19.393 16.086-27.905zm-32.64 72.32 36.693 38.4a21.31 21.31 0 0 0 15.424 6.592c1.536 0 3.115-.171 4.651-.512l63.616-14.208c-.853 5.888-1.515 11.883-2.112 17.92-.32 3.051-.683 6.037-.917 9.131a360.392 360.392 0 0 0-.469 7.019l-79.381 20.821-45.504-47.595c1.962-13.013 4.629-25.557 7.999-37.568zm-11.626 95.488 26.987 28.245a21.345 21.345 0 0 0 15.424 6.592c1.813 0 3.627-.235 5.419-.704l80.597-21.141c.149 3.179.32 6.357.555 9.515.235 3.093.597 6.08.917 9.131.683 6.912 1.515 13.739 2.539 20.437.064.363.085.725.128 1.067l-87.765 23.232L49.9 324.736c-4.097-19.307-6.508-39.765-6.977-60.907zm23.424 113.728 11.84 4.843a21.17 21.17 0 0 0 8.085 1.6 21.56 21.56 0 0 0 5.461-.704l92.821-24.597c2.005 7.019 4.139 13.909 6.528 20.544.107.32.256.619.363.939a300.07 300.07 0 0 0 8.533 21.013L94.464 425.792c-10.773-13.611-20.288-29.845-28.117-48.235zm104.32 91.776c-12.459 0-24.533-3.264-36.011-9.088l83.52-19.456c1.131-.277 2.005-.981 3.072-1.408 1.707 2.517 3.541 4.843 5.333 7.253 1.365 1.835 2.667 3.776 4.075 5.547 4.757 5.995 9.685 11.691 14.869 16.896.085.085.149.171.235.256h-75.093zm74.858-426.41c-5.184 5.205-10.112 10.901-14.869 16.896-1.365 1.728-2.624 3.563-3.947 5.355l-91.69 18.346-19.2-19.221c16.747-13.675 35.328-21.632 54.848-21.632h75.093c-.085.085-.149.17-.235.256zm95.808 383.744C285.312 426.667 256 340.821 256 256s29.312-170.667 85.333-170.667S426.666 171.178 426.666 256s-29.311 170.667-85.333 170.667z" />
											<path d="M341.333 128c-15.04 0-42.667 48.597-42.667 128s27.627 128 42.667 128C356.373 384 384 335.403 384 256s-27.627-128-42.667-128z" />
										</svg>
									</div>
									<div className="pager-body__services__content__box__item--text">
